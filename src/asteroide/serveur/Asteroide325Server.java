...
public class Asteroide325Server extends UnicastRemoteObject implements Asteroide325, Runnable {
	...
	public void run() {
		...
		while (true) {
			try {
				...
				Thread.sleep(1000);	//? : dormir 'au plus' 1 seconde (difference temps execution et 1sec.)
	...
	public static void main(String[] args) throws Exception {
	    ...
	    while(true) {
	    	System.out.println("[Asteroide 325 sur "+InetAddress.getLocalHost().getCanonicalHostName()+":"+port+"] "
